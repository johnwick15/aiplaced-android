...
- Signed, stateless Google sign-in challenges with a dedicated Android client audience
...
Install CSCAPrep Core 1.12.44 or newer on `https://cscaprep.com` before using this app. Configure the website and Android Google client IDs, Stripe keys, one-time Stripe Price IDs and Stripe webhook in CSCAPrep settings.
